...
df_PakistanSindh <- load_MICS_mort_dataset("PakistanSindh")
df_PakistanKhyber <- load_MICS_mort_dataset("PakistanKhyber")
df_hond <- load_MICS_mort_dataset("Honduras")
df_tac <- load_MICS_mort_dataset("Turks and Caicos")
df_tuv <- load_MICS_mort_dataset("Tuvalu")
df_viet <- load_MICS_dataset("Vietnam")
