  ...
  mutate(
    ...
    Xlab = case_when(X=="EC_H" ~ "Contaminated\nHH water", 
                     ...
                     X=="hyg_imp_cat" ~ "Hygiene\ncategory",
                      ...
                      X=="imp_on_prem_sufficient_HQ_V_imp_on_prem_insufficient_HQ" ~ "Imp. on prem. insuff. HQ\n(ref:Imp. on prem. suff. HQ)",
                      X=="imp_on_prem_sufficient_LQ_V_imp_on_prem_insufficient_LQ" ~ "Imp. on prem. insuff. LQ\n(ref:Imp. on prem. suff. LQ)",
                      X=="POU_anytreatment" ~ "POU any\nwater treatment", 
                      X=="POU_chlorine" ~ "POU chlorine\ntreatment", 
                      X=="POU_filter" ~ "POU filter\ntreatment", 
                      X=="POU_solar" ~ "POU solar\ntreatment"),
    Xlab=factor(Xlab, levels = rev(c(
      ...
      "Imp. on prem. insuff. LQ\n(ref:Imp. on prem. suff. LQ)",
      "Imp. on prem. insuff. HQ\n(ref:Imp. on prem. suff. HQ)",
      "POU any\nwater treatment", "POU chlorine\ntreatment", 
      "POU filter\ntreatment",  "POU solar\ntreatment"))),
    Xlab2 = case_when(X=="EC_H" ~ "Contaminated HH water", 
                     ...
                     X=="POU_anytreatment" ~ "POU any water treatment", 
                     X=="POU_chlorine" ~ "POU chlorine treatment", 
                     X=="POU_filter" ~ "POU filter treatment", 
                     X=="POU_solar" ~ "POU solar treatment"),
    Xlab2=factor(Xlab2, levels = rev(c(
      ...
      "Imp. on prem. insuff. LQ (ref:Imp. on prem. suff. LQ)",
      "Imp. on prem. insuff. HQ (ref:Imp. on prem. suff. HQ)",
      "POU any water treatment", "POU chlorine treatment", 
      "POU filter treatment",  "POU solar treatment"
      ))),
    contrast = case_when(
